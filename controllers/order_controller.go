...
// 		totalOrder := float64(item.Quantity) * menu.Price
...
// 			TotalPrice: totalOrder, // Calculate total price based on the Menu price and quantity
// 		}
...
// 	// Convert To Response
// 	orderResponse := dto.ConvertToOrderResponse(order, orderReq.Items)
